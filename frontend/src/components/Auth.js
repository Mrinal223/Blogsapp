...
const Auth = () => {
  ...
  return <div>
    ...
    <form onSubmit={handleSubmit}>
      <Box maxWidth={500} display="Flex" flexDirection={"column"} alignItems="center" justifyContent={"center"}
        boxShadow="20px 50px 30px 30px #ccc" padding={3} margin="auto" marginTop={5} borderRadius={5} >
        ...
        <Button type="submit" variant="contained" sx={{ borderRadius: 3, marginTop: 3 }} color="secondary">Submit</Button>
